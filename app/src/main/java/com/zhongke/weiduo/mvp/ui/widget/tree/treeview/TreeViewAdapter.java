...
import com.zhongke.weiduo.mvp.ui.widget.tree.treeview.base.CheckableNodeViewBinder;
import com.zhongke.weiduo.mvp.ui.widget.tree.treeview.helper.TreeHelper;
...
public class TreeViewAdapter extends RecyclerView.Adapter {
    ...
    private BaseNodeViewBinder nodeViewBinder;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int level) {
        ...
        nodeViewBinder = baseNodeViewFactory.getNodeViewBinder(view, level);
            ...
            if (triggerToggleView != null) {
                triggerToggleView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        viewBinder.onItemClick(treeNode);
                    }
                });
            }
    ...
    public void expandNode(TreeNode treeNode) {
        ...
        Log.i("llj","TreeViewAdapter,expandNode()");
    }
    ...
    public void collapseNode(TreeNode treeNode) {
        ...
        Log.i("llj","TreeViewAdapter,collapseNode()");
    }
