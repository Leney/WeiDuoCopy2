...
public class SchemeCommentPresenter extends BasePresenter {
    private static final String TAG = "SchemeCommentPresenter";
    private Context mContext;
    private DataManager mDataManager;
    private SchemeCommentContract mContract;

    public SchemeCommentPresenter(Context context, DataManager dataManager, SchemeCommentContract contract) {
