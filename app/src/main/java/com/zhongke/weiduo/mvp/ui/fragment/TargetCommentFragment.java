...
import com.zhongke.weiduo.mvp.contract.TargetCommentContract;
import com.zhongke.weiduo.mvp.model.entity.CommentBean;
import com.zhongke.weiduo.mvp.presenter.TargetCommentPresenter;
 ...
 */
public class TargetCommentFragment extends BaseMvpFragment implements TargetCommentContract {
    private TargetCommentPresenter mPresenter;
...
//    public MyScrollView mScrollView;
    ...
    public static TargetCommentFragment newInstance(int id) {
        TargetCommentFragment instance = new TargetCommentFragment();
        instance.id = id;
        return instance;
    }
...
//    }
    ...
    protected BasePresenter createPresenter() {
        return mPresenter = new TargetCommentPresenter(getActivity(), mDataManager, this);
    }
