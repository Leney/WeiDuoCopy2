...
public class SessionAdapter extends LQRAdapterForRecyclerView<Session> {
    ...
    public SessionAdapter(Context context, List<Session> data, SessionAtPresenter presenter) {
        super(context, data);
