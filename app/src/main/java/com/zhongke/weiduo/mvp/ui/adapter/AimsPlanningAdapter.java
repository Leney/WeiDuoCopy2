...
public class AimsPlanningAdapter extends RecyclerView.Adapter<AimsPlanningAdapter.AimsViewHolder> implements SlidingButtonView.IonSlidingButtonListener {
    ...
    public AimsPlanningAdapter(List<MyTargetBean.RecordsBean> list, Context context, int current) {
        this.list = list;
...
//        holder.progress_text.setText(String.valueOf(bean.progress)+"%");
...
//            system_source = (TextView) itemView.findViewById(R.id.tv_system_source);
            ((SlidingButtonView) itemView).setSlidingButtonListener(AimsPlanningAdapter.this);
        }
    }
