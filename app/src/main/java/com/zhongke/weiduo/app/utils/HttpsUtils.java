...
public class HttpsUtils {
    public SSLSocketFactory getSSlFactory(Context context) {
        ...
        try {
            ...
            InputStream caInput = new BufferedInputStream(context.getAssets().open("uwca.crt"));
            Certificate ca;
            try {
                ca = cf.generateCertificate(caInput);
                LogUtil.i("Longer", "ca=" + ((X509Certificate) ca).getSubjectDN());
                LogUtil.i("Longer", "key=" + ((X509Certificate) ca).getPublicKey());
            } finally {
                caInput.close();
            }
