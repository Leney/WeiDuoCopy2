...
public class MyTaskListAdapter extends BaseAdapter {
    ...
    private List<TaskListBean.MyTaskBean> list;
    ...
    private void setDataShow(ViewHolder viewHolder, int position) {
        TaskListBean.MyTaskBean actionBean = list.get(position);
        //设置字体颜色
     ...
     */
    public void changData(List<TaskListBean.MyTaskBean> actionBeanList) {
        this.list.clear();
        this.list.addAll(actionBeanList);
        this.notifyDataSetChanged();
    }
    public List<TaskListBean.MyTaskBean> getTaskList() {
        return list;
    }
