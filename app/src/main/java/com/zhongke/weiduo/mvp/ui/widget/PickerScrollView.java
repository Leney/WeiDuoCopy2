...
public class PickerScrollView extends View {
     ...
     * @return
     */
    public Pickers getCurSelectedItem() {
...
//        canvas.drawLine(0, baseline, mViewWidth, baseline, mPaint);
        ...
        mPaint.setColor(Color.parseColor("#1cbf61"));
        canvas.drawText(textData, x, baseline, mPaint);

//        mPaint.setColor(Color.RED);
//        canvas.drawLine(0, baseline + size, mViewWidth, baseline + size, mPaint);
    ...
    public void selecteItemColor(int color) {
