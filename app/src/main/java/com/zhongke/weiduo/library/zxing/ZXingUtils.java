package com.zhongke.weiduo.library.zxing;
...
public class ZXingUtils {
    ...
    public static Bitmap createQRImage(String content, int widthPix, int heightPix, Bitmap logoBm) {
        ...
        try {
            ...
            Hashtable<EncodeHintType, Object> hintsMap = new Hashtable<>();
    ...
    private static String writeFile(Bitmap bitmap) {
        ...
        try {
            filePath = BitmapUtils.getBitmapDiskFile(ZkApplication.getInstance()).getAbsolutePath();
