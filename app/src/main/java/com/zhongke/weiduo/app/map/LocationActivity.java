package com.zhongke.weiduo.app.map;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_send:  //发送
                ...
                intent.putExtra("lat", mLoactionLatLng.latitude);
                intent.putExtra("lng", mLoactionLatLng.longitude);
                LogUtil.e("kevin", "----->地图返回的数据" + mLocationValue + "经纬度" + mLoactionLatLng.latitude + ", " + mLoactionLatLng.longitude);
