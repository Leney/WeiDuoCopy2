...
public class StringUtils {
    ...
    private final static Pattern password = Pattern.compile("^(?=.*?[0-9])[a-zA-Z0-9]{8,12}$");
     ...
     * @return
     */
    public static String getIndexString(int stringId) {
        return ZkApplication.getInstance().getResources().getString(stringId);
    }
}
