...
public class MySchemeListAdapter extends RecyclerView.Adapter<MySchemeListAdapter.AimsViewHolder> implements SlidingButtonView.IonSlidingButtonListener {
    private SlidingButtonView mMenu = null;
    private List<MySchemeBean.RecordsBean> list;
    private Activity context;
    private IonSlidingViewClickListener mIDeleteBtnClickListener;

    public MySchemeListAdapter(List<MySchemeBean.RecordsBean> list, Context context) {
        this.list = list;
        this.context = (Activity) context;
        mIDeleteBtnClickListener = (IonSlidingViewClickListener) context;
    }

    public void updateData(List<MySchemeBean.RecordsBean> list) {
        this.list = list;
    ...
    public void onBindViewHolder(AimsViewHolder holder, int position) {
        MySchemeBean.RecordsBean bean = list.get(position);
...
//            system_source = (TextView) itemView.findViewById(R.id.tv_system_source);
            ((SlidingButtonView) itemView).setSlidingButtonListener(MySchemeListAdapter.this);
        }
    }
