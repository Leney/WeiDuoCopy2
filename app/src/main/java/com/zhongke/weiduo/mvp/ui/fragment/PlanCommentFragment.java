...
import com.zhongke.weiduo.mvp.presenter.PlanCommentPresenter;
 ...
 */
public class PlanCommentFragment extends BaseMvpFragment implements PlanCommentContract {
    private PlanCommentPresenter mPresenter;
...
//    public MyScrollView mScrollView;
    ...
    public static PlanCommentFragment newInstance(int id) {
        PlanCommentFragment instance = new PlanCommentFragment();
        instance.id = id;
        return instance;
    }
...
//    }
    ...
    protected BasePresenter createPresenter() {
        return mPresenter = new PlanCommentPresenter(getActivity(), mDataManager, this);
    }
