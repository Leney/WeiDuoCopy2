...
public class TargetCommentPresenter extends BasePresenter {
    private static final String TAG = "TargetCommentPresenter";
    private Context mContext;
    private DataManager mDataManager;
    private TargetCommentContract mContract;

    public TargetCommentPresenter(Context context, DataManager dataManager, TargetCommentContract contract) {
