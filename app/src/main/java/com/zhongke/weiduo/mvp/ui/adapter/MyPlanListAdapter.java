...
public class MyPlanListAdapter extends RecyclerView.Adapter<MyPlanListAdapter.AimsViewHolder> implements SlidingButtonView.IonSlidingButtonListener {
    private SlidingButtonView mMenu = null;
    private List<MyPlanBean.RecordsBean> list;
    private Activity context;
    private IonSlidingViewClickListener mIDeleteBtnClickListener;

    public MyPlanListAdapter(List<MyPlanBean.RecordsBean> list, Context context) {
        this.list = list;
        this.context = (Activity) context;
        mIDeleteBtnClickListener = (IonSlidingViewClickListener) context;
    }

    public void updateData(List<MyPlanBean.RecordsBean> list) {
        this.list = list;
    ...
    public void onBindViewHolder(AimsViewHolder holder, int position) {
        MyPlanBean.RecordsBean bean = list.get(position);
...
//            system_source = (TextView) itemView.findViewById(R.id.tv_system_source);
            ((SlidingButtonView) itemView).setSlidingButtonListener(MyPlanListAdapter.this);
        }
    }
